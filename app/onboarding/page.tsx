...
import {
  isCompliantLobbyNickname,
  nicknameRequiresLatinMigration,
        ...
        if (!guest) {
          ...
          if (!cancelled && !data.session) {
            ...
            if (!cancelled && row?.nickname) {
              ...
              setNicknameLocked(
                !isAutoGeneratedLobbyNickname(row.nickname) && isCompliantLobbyNickname(row.nickname)
              );
            }
          }
        }
            ...
            <div>
              ...
              <p className="mb-1 text-[11px] leading-snug text-muted-foreground">
                {nicknameLocked
                  ...
                  : nicknameRequiresLatinMigration(form.nickname)
                    ? "Lobby nicknames are Latin-only (A–Z, numbers, space, dot, hyphen). Replace yours below — same account, new compliant name."
                    : configured
                      ? "Pick a unique Latin-only lobby name. After you save a compliant name, it stays yours for this account."

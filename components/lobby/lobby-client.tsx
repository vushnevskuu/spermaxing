...
export function LobbyClient() {
  ...
  return (
    ...
    >
      ...
      {eggArcadeOpen ? (
        <div
          className="fixed inset-0 z-[100] flex min-h-0 min-w-0 flex-col overflow-x-hidden overflow-y-auto bg-background pt-[env(safe-area-inset-top,0px)] pb-[env(safe-area-inset-bottom,0px)]"
          role="dialog"
          aria-modal="true"
